...
def FetchData(data_place:str) -> list :
    image_dir = os.path.join(data_place, "Images")
...
if __name__=="__main__":
    ...
    parser.add_argument('-data-place', type=str, default='./cfp-dataset/Data', help='prepared data path to run program')
    # model
    ...
    if args.random:
        ...
        # try:
        images, id_labels, pose_labels, Nd, Np, Nz, channel_num = FetchData(args.data_place)
